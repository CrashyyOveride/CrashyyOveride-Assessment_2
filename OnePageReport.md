...
Array-Based Question Bank: Questions are stored in an Array of Objects. This design decision follows the DRY (Don't Repeat Yourself) principle, allowing the same HTML structure to be reused for infinite questions.
